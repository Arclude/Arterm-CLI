...
**Examples:**
- `#project:arterm` - Project-specific
...
- [x] User control CLI (`arterm memory` commands)
...
Similar to how humans consolidate memories during sleep, arterm can run background consolidation to optimize the memory graph:
