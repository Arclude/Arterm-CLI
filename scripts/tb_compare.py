#!/usr/bin/env python3
"""Aggregate a arterm Terminal-Bench Harbor job dir and compare against the
...
def main() -> int:
    ...
    rows = []
    arterm_resolved = arterm_trials = 0
    regressions = []
    ...
    print(f"{'task':38} {'base%':>7} {'arterm%':>7} {'pass':>6} {'flag'}")
    print("-" * 75)
    ...
    print("-" * 75)
    if arterm_trials:
        print(f"arterm micro-avg: {arterm_resolved}/{arterm_trials} = {100*arterm_resolved/arterm_trials:.1f}%")
