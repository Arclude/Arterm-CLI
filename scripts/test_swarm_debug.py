...
SOCKET_PATH = f"/run/user/{os.getuid()}/arterm-debug.sock"
MAIN_SOCKET_PATH = f"/run/user/{os.getuid()}/arterm.sock"
...
def main():
    ...
    if not os.path.exists(SOCKET_PATH):
        ...
        print("Make sure arterm server is running with debug control enabled.")
