#!/usr/bin/env python3
"""
Reproduce the "slash command menu flickers in a freshly spawned arterm" bug.
...
def main() -> int:
    ...
    root = Path(tempfile.mkdtemp(prefix="arterm-slash-flicker-"))
    ...
    env.setdefault("ARTERM_PERF_TIER", "full")
    ...
    if not args.json:
        print("== arterm slash-menu flicker repro ==")
