#!/bin/bash
# Screenshot Watcher - monitors for arterm screenshot signals
#
# This script watches the signal directory and captures screenshots
# when arterm signals that a specific UI state is ready.
#
# Usage: ./screenshot_watcher.sh [window_id]
#
# Start arterm with: /screenshot-mode on

set -e

SIGNAL_DIR="${XDG_RUNTIME_DIR:-/tmp}/arterm-screenshots"
...
echo "Enable in arterm with: /screenshot-mode on"
echo ""
