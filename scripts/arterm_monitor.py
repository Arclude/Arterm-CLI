#!/usr/bin/env python3
"""
arterm Live Monitor - Real-time activity dashboard

Connects to arterm's debug socket and displays live streaming events.
Run arterm serve in one terminal, then this monitor in another.

Usage: ./arterm_monitor.py [--socket PATH]
"""
...
def get_socket_path() -> str:
    """Get the arterm debug socket path"""
