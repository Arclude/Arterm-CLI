...
The existing `arterm-plan` graph code is the foundation; this is an evolution of
it, not a rewrite.
...
The pressures above are implemented as hard engine rules in `arterm-plan`'s
...
## 10. Data model changes (against `arterm-plan`)
