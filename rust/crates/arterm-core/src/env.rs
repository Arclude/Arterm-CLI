...
/// Mutate the process environment for arterm runtime configuration.
///
/// Rust 2024 makes environment mutation unsafe because it can race with
/// concurrent environment access in foreign code. arterm intentionally mutates
...
where
    ...
    V: AsRef<OsStr>,
{
    // SAFETY: arterm treats these mutations as process-global configuration.
...
/// Remove a process environment variable used by arterm runtime configuration.
