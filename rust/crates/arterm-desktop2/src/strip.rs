...
mod tests {
    ...
    fn strip() -> Strips {
        Strips::build(
            vec![
                Panel::new("a1", Some("/home/j/arterm")),
                Panel::new("a2", Some("/home/j/arterm")),
                Panel::new("a3", Some("/home/j/arterm")),
    ...
    fn grouping_is_by_working_dir_and_is_stable() {
        ...
        assert_eq!(strip.strips()[0].label, "arterm");
    ...
    fn label_uses_the_leaf_directory() {
        assert_eq!(label_for(Some("/home/j/arterm")), "arterm");
        assert_eq!(label_for(Some("/home/j/arterm/")), "arterm");
