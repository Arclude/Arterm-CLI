...
//! - Markdown and LaTeX come from [`arterm_render_core`], the backend-neutral
...
fn checkbox_spans(spans: &[arterm_render_core::StyledSpan]) -> Vec<arterm_render_core::StyledSpan> {
...
fn table_lines(rows: &[Vec<String>], alignments: &[Alignment], columns: usize) -> Vec<StyledLine> {
    use arterm_render_core::{StyledSpan, TextAttrs};
