...
//!
//! This drives the *real* task-DAG engine (`arterm_plan::dag`) with scripted mock
...
//!
//! Run with: `cargo run -p arterm-plan --example swarm_agent_count`
//!
...
use arterm_plan::dag::sim::deep_artifact;
use arterm_plan::dag::{
