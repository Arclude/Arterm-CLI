...
use crate::{ApiEvent, Error, ArtermClient, RunOptions, ToolCall, TurnResult, Usage};
...
/// JSON Schema accepted by [`ArtermClient::run_structured`].
...
/// One model attempt made by [`ArtermClient::run_structured`].
#[derive(Debug, Clone, PartialEq, Eq)]
...
/// An invalid JSON Schema supplied to [`ArtermClient::run_structured`].
#[derive(Debug, Clone, PartialEq, Eq)]
