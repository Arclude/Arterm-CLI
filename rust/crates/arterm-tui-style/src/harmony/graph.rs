...
//!
//! Node weights and edges are *measured*, not declared: `arterm-tui` renders real
...
/// The topology measured from arterm's own rendered frames.
///
/// Regenerate with
...
///
/// Area weighting is the entire point. arterm's default palette measures 0.10
