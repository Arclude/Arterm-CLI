//! Provider-doctor diagnostics for arterm.
//!
//! Sits downstream of `arterm-base` so edits to the doctor cluster do not
//! rebuild the base -> app-core -> tui spine:
//! - [`provider_e2e`]: the strict end-to-end runner behind `arterm
