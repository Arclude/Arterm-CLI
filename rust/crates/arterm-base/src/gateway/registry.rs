...
use crate::storage;
use arterm_gateway_types::{PairedDevice, PairingCode};

// ---------------------------------------------------------------------------
// Device registry (persisted to ~/.arterm/devices.json)
// ---------------------------------------------------------------------------
...
impl DeviceRegistry {
    /// Load from ~/.arterm/devices.json
    pub fn load() -> Self {
        let path = match storage::arterm_dir() {
    ...
    /// Save to ~/.arterm/devices.json
    pub fn save(&self) -> Result<()> {
        let path = storage::arterm_dir()?.join("devices.json");
