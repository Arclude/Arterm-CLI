...
//! downstream `arterm-provider-openrouter-runtime` crate so provider edits do
...
pub fn standard_catalog_lists_model(model_id: &str) -> Option<bool> {
    let cache = arterm_provider_openrouter::load_disk_cache_entry_for_namespace("openrouter")?;
