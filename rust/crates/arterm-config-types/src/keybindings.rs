...
//!
//! Historically arterm used a single shared list of default keybindings for
...
pub const KEYBINDING_DEFAULTS: &[KeybindingDefault] = &[
    ...
    KeybindingDefault {
        id: "new_terminal",
        description: "Spawn a fresh arterm session in a new terminal window",
        // Companion to the system-wide launch hotkey (Cmd+; / Alt+;): the
        // shifted variant spawns a new session from inside arterm, reusing the
    ...
    KeybindingDefault {
        ...
        // Cmd+B is free in arterm on macOS. On Windows/Linux, Ctrl+R is already
