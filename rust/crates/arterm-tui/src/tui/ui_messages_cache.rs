...
pub(super) use arterm_tui_messages::{centered_wrap_width, left_pad_lines_for_centered_mode};
...
{
    arterm_tui_messages::get_cached_message_lines(
        msg,
        width,
        diff_mode,
        arterm_tui_messages::MessageCacheContext {
