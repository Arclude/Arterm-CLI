...
fn test_top_level_command_suggestions_include_project_local_skills() {
    ...
    // found under <working_dir>/.arterm/skills, independent of the skills
...
fn test_swarm_prompt_command_is_discoverable_in_suggestions_and_help() {
    ...
    assert!(help.contains(".arterm/swarm-prompt.md"));
    assert!(help.contains("Restart or reload Arterm"));
}
