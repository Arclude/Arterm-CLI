...
impl App {
    ...
    pub(super) fn update_cost_impl(&mut self) {
        ...
        let pinned_anthropic = arterm_provider_core::pinned_mode_for(
            arterm_provider_core::DualAuthProvider::Anthropic,
            runtime_provider.as_deref(),
        );
        let pinned_openai = arterm_provider_core::pinned_mode_for(
        ...
        let is_explicit_openai_oauth =
            matches!(pinned_openai, Some(arterm_provider_core::AuthMode::Oauth));
