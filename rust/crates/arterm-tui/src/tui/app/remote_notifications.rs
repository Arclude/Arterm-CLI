    ...
    } = notification_type
    {
        ...
        if !tldr.is_empty() && !presentation.message.trim().is_empty() {
            ...
            presentation.message =
                arterm_tui_messages::encode_collapsible_swarm_content(tldr, &presentation.message);
        }
    }
    presentation
}
        ...
        NotificationType::FileConflict {
            ...
            SwarmNotificationPresentation {
                ...
                message: if has_details {
                    arterm_tui_messages::encode_collapsible_swarm_content(
                        &summary_line,
                        &detail_body,
                    )
                } else {
...
mod tests {
    ...
    fn present_swarm_notification_with_tldr_encodes_collapsed_content() {
        ...
        let parsed = arterm_tui_messages::parse_collapsible_swarm_content(&presentation.message)
    ...
    fn present_swarm_notification_without_tldr_keeps_plain_content() {
        ...
        assert!(
            arterm_tui_messages::parse_collapsible_swarm_content(&presentation.message).is_none()
        );
    ...
    fn present_swarm_notification_formats_file_activity_with_compact_path_and_preview() {
        let presentation = present_swarm_notification(
            "moss",
            &NotificationType::FileConflict {
                path: "/home/jeremy/arterm/src/tool/communicate.rs".to_string(),
            ...
            "⚠ File activity: /home/jeremy/arterm/src/tool/communicate.rs - moss just edited this file you previously worked with: edited lines 323-348 (1 occurrence)",
            false,
        );
        ...
        assert_eq!(
            parsed.tldr,
            "…/arterm/src/tool/communicate.rs · Edited lines 323-348 (1 occurrence)"
        );
        ...
        assert_eq!(
            presentation.status_notice,
            "File activity · …/arterm/src/tool/communicate.rs"
        );
    }
