use super::{Agent, ARTERM_REPO_SOURCE_STATE, WORKING_GIT_STATE_CACHE};
use crate::logging;
...
impl Agent {
    ...
    pub(super) fn build_env_snapshot(
        ...
        let (arterm_git_hash, arterm_git_dirty) = match detail {
            EnvSnapshotDetail::Full => ARTERM_REPO_SOURCE_STATE.clone(),
        ...
        EnvSnapshot {
            ...
            arterm_version: arterm_build_meta::version().to_string(),
            arterm_git_hash,
            arterm_git_dirty,
