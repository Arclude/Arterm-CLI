        ...
        json!({
            ...
            "properties": {
                ...
                "engine": {
                    ...
                    "description": "Engine. Defaults to duckduckgo; bing uses ARTERM_BING_API_KEY, searxng uses ARTERM_SEARXNG_URL."
                },
                "bing_market": {
                    "type": "string",
                    "description": "Optional Bing market, e.g. en-US or zh-CN. Defaults to ARTERM_BING_MARKET or en-US."
                }
            }
        })
    }
        ...
        if results.is_empty() {
            return Ok(ToolOutput::new(format!(
                "No results found for: {}\n\n\
                 ...
                 ARTERM_SEARXNG_URL) and use engine \"searxng\".\n\
                 - Or provide a Bing Search API key via ARTERM_BING_API_KEY.",
                params.query
            )));
        }
...
mod tests {
    ...
    fn parses_bing_html_results() {
        let html = r#"
            ...
            <li class="b_algo">
              <h2><a href="https://example.org/arterm">Arterm</a></h2>
        ...
        assert_eq!(results[1].title, "Arterm");
    }
