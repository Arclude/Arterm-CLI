...
//! correctness bug, not a crash. arterm budgets prompts and triggers compaction
...
/// provider families arterm ships. Kept deliberately broad rather than exact:
...
/// guess outranks ground truth, arterm over-budgets a real endpoint. Note the
