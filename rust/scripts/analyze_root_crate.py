#!/usr/bin/env python3
"""Analyze the monolithic root `arterm` crate to plan a bottom-up split.
...
computes:
  ...
  - facade: whether it is already just `pub use arterm_*::*;`
...
FACADE_RE = re.compile(r"pub use arterm_[a-z0-9_]+::")
