...
small: it blocks direct dependencies from any `arterm-*-types` crate to root or
...
FORBIDDEN_INTERNAL_DEPS = {
    ...
    "arterm-provider-metadata",
    "arterm-provider-openrouter",
    "arterm-protocol",
    "arterm-terminal-launch",
    "arterm-tui-core",
    "arterm-tui-markdown",
    "arterm-tui-mermaid",
    "arterm-tui-render",
    "arterm-tui-workspace",
}
...
def is_type_crate(name: str) -> bool:
    return name.startswith("arterm-") and name.endswith("-types")
