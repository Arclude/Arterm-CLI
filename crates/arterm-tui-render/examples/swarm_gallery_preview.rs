...
//!
//! Run with: `cargo run --profile selfdev -p arterm-tui-render --example swarm_gallery_preview`
...
use arterm_tui_render::swarm_tiles::{SwarmGalleryConfig, SwarmTile, render_swarm_gallery};
use ratatui::prelude::*;
