...
const STATE_ABI: u64 = parse_hex(env!("ARTERM_DESKTOP2_STATE_ABI"));
const WORKER_BUILD: u64 = parse_hex(env!("ARTERM_DESKTOP2_WORKER_BUILD"));
const ENTRYPOINT: &[u8] = b"arterm_desktop2_worker_api_v1\0";
...
/// Exported by `libarterm_desktop2.so`, not used to create another native app.
#[unsafe(no_mangle)]
pub extern "C" fn arterm_desktop2_worker_api_v1() -> *const WorkerApi {
    &BUILTIN_API
}
