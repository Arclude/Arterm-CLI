...
fn draw_hero_text(
    ...
    // The wordmark: the same "arterm" that sits above the donut on the website.
...
/// (`arterm-website arterm arterm-desktop2 ...`) and grew with every checkout.
...
fn draw_transcript(
    ...
    use arterm_render_core::BlockKind;
...
pub fn build_scene(
...

    {
        ...
        // "message arterm" is a caption you stop seeing, while a prompt you
