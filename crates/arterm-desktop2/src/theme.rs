...
impl Theme {
    ...
    /// The mode asked for by `ARTERM_DESKTOP2_THEME=light|dark|system`.
    ...
    pub fn preference_from_env() -> ThemeMode {
        match std::env::var("ARTERM_DESKTOP2_THEME").as_deref() {
    ...
    /// Resolve from the environment: `ARTERM_DESKTOP2_THEME=light|dark|system`.
