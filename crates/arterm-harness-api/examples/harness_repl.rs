...
//!
//! Usage:
//!   cargo run -p arterm-harness-api --example harness_repl -- \
//!     [socket_path] [message]
//!
...
//!   cargo run -p arterm-harness-api --example harness_repl -- --demo
...
fn default_socket_path() -> String {
    ...
    format!("{home}/.arterm/arterm-api.sock")
}
        ...
        while {
            ...
            match req["req"].as_str().unwrap_or("") {
                ...
                "create_session" => reply(&ServerFrame::reply(
                    id,
                    ApiEvent::Attached {
                        session: arterm_harness_api::SessionInfo {
