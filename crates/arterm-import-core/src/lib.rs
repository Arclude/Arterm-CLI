...
/// `arterm_core::util::truncate_str`, duplicated here to keep this leaf crate
/// free of the heavier `arterm-core` dependency.
...
11111111-2222-3333-4444-555555555555/11111111-2222-3333-4444-555555555555.jsonl",
    ...
    fn claude_title_candidate_skips_command_wrappers() {
        ...
        assert_eq!(
            claude_title_candidate("can you fix my arterm server version?"),
            Some("can you fix my arterm server version?".into())
        );
    }
