//! Client-server protocol for arterm
//!
...
use arterm_batch_types::BatchProgress;
use arterm_message_types::{InputShellResult, ToolCall};
use arterm_plan::{PlanItem, VersionedPlan, next_runnable_item_ids, summarize_plan_graph};
use arterm_side_panel_types::{SidePanelSnapshot, snapshot_is_empty};
...
pub type ReloadRecoverySnapshot = arterm_selfdev_types::ReloadRecoveryDirective;

mod wire;
pub use wire::TaskGraphNodeSpec;
pub use wire::{AskUserWireOption, BgTaskSummary, Request, ServerEvent};
...
impl PlanGraphStatus {
    ...
    pub fn from_versioned_plan(
        ...
        let growth = arterm_plan::bridge::growth_stats(plan);
        ...
        Self {
            ...
            newly_ready_ids,
            low_confidence_ids: arterm_plan::bridge::low_confidence_completed_ids(plan),
