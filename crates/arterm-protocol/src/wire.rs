...
/// Mirrors `arterm_plan::dag::NodeSpec` but kept as an explicit wire type so the
...
pub enum Request {
    ...
    SetCompactionMode {
        id: u64,
        mode: arterm_config_types::CompactionMode,
    },
    ...
    /// Query arterm agent's capabilities
...
pub enum ServerEvent {
    ...
    SidePaneImages {
        session_id: String,
        images: Vec<arterm_session_types::RenderedImage>,
    },
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        available_model_routes: Vec<arterm_provider_core::ModelRoute>,
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        resolved_credential: Option<arterm_provider_core::ResolvedCredential>,
    ...
    CommListModelsResponse {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        model_routes: Vec<arterm_provider_core::ModelRoute>,
    },
