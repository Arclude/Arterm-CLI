...
//!
//! Configuration lives in `~/.arterm/config.toml`:
//!
//! ```toml
//! [display.colors]
//! user = "#8ab4f8"
...
impl Role {
    ...
    /// Built-in default RGB, matching arterm's historical hard-coded palette.
...
/// pass exists because arterm's *built-in* palette is designed for dark
...
mod light_theme_interaction {
    ...
    ///
    /// The light adapter exists because arterm's *built-in* palette is designed
...
mod default_palette_is_frozen {
    ...
    /// The exact hand-tuned palette arterm has always shipped.
    ///
