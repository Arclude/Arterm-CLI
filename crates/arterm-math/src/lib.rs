//! TeX-style math typesetting for arterm front-ends.
//!
//! `arterm-math` turns LaTeX math source into positioned glyphs and rules using
...
//!
//! ```
//! let engine = arterm_math::MathLayoutEngine::stix();
