...
fn derive_session_provider_key_prefers_runtime_identity_over_transport() {
    let _lock = lock_env();
    let _runtime = EnvVarGuard::set("ARTERM_RUNTIME_PROVIDER", "azure-openai");
    let _namespace = EnvVarGuard::set("ARTERM_OPENROUTER_CACHE_NAMESPACE", "azure-cache");
    let _active = EnvVarGuard::set("ARTERM_ACTIVE_PROVIDER", "openrouter");
...
fn derive_session_provider_key_falls_back_to_openrouter_namespace() {
    let _lock = lock_env();
    let _runtime = EnvVarGuard::remove("ARTERM_RUNTIME_PROVIDER");
    let _namespace = EnvVarGuard::set("ARTERM_OPENROUTER_CACHE_NAMESPACE", "azure-openai");
    let _active = EnvVarGuard::set("ARTERM_ACTIVE_PROVIDER", "openrouter");
...
fn derive_session_provider_key_keeps_openai_compatible_profile_namespace() {
    let _lock = lock_env();
    let _runtime = EnvVarGuard::set("ARTERM_RUNTIME_PROVIDER", "openai-compatible");
    let _namespace = EnvVarGuard::set("ARTERM_OPENROUTER_CACHE_NAMESPACE", "zai");
    let _active = EnvVarGuard::set("ARTERM_ACTIVE_PROVIDER", "openrouter");
...
fn initial_session_context_preserves_explicitly_bound_cwd_when_inserted() -> Result<()> {
    ...
    let first_dir = tempfile::Builder::new()
        .prefix("arterm-session-context-first-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let second_dir = tempfile::Builder::new()
        .prefix("arterm-session-context-second-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
...
fn initial_session_context_can_refresh_before_real_conversation() -> Result<()> {
    ...
    let original_cwd = std::env::current_dir().map_err(|e| anyhow!(e))?;
    let first_dir = tempfile::Builder::new()
        .prefix("arterm-session-context-stale-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let second_dir = tempfile::Builder::new()
        .prefix("arterm-session-context-real-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
...
fn initial_session_context_does_not_refresh_after_real_conversation() -> Result<()> {
    ...
    let original_cwd = std::env::current_dir().map_err(|e| anyhow!(e))?;
    let first_dir = tempfile::Builder::new()
        .prefix("arterm-session-context-original-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let second_dir = tempfile::Builder::new()
        .prefix("arterm-session-context-late-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
...
fn load_startup_stub_preserves_metadata_but_skips_heavy_vectors() -> Result<()> {
    ...
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-startup-stub-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    ...
    session.record_env_snapshot(EnvSnapshot {
        ...
        arterm_git_hash: Some("abc123".to_string()),
        arterm_git_dirty: Some(false),
        os: "linux".to_string(),
...
fn load_for_remote_startup_preserves_messages_and_replay_but_skips_heavy_vectors() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-remote-startup-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_create_marks_debug_when_test_session_env_enabled() {
    let _env_lock = lock_env();
    let _test_flag = EnvVarGuard::set("ARTERM_TEST_SESSION", "1");
...
fn test_recover_crashed_sessions_preserves_debug_flag() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-recover-debug-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
    let _test_flag = EnvVarGuard::set("ARTERM_TEST_SESSION", "0");
...
fn test_recover_crashed_sessions_by_ids_restores_only_selected_group() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-recover-selected-crash-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
    let _test_flag = EnvVarGuard::set("ARTERM_TEST_SESSION", "0");
...
fn test_save_persists_full_session_content() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-session-save-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_save_persists_compaction_state() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-session-compaction-save-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_save_persists_provider_key() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-session-provider-key-save-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_save_persists_reasoning_effort() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-session-reasoning-effort-save-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_save_appends_journal_and_load_replays_it() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-session-journal-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_save_checkpoints_after_full_mutation_and_clears_journal() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-session-checkpoint-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_journal_replay_skips_corrupt_line_and_keeps_tail() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-session-journal-corrupt-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_journal_replay_salvages_glued_entries_on_torn_line() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-session-journal-glued-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_corrupt_journal_heals_via_checkpoint_on_next_save() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-session-journal-heal-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn test_render_messages_renders_reasoning_before_answer_in_stored_order() {
    ...
    use arterm_render_core::REASONING_SENTINEL;

    let _env_lock = lock_env();
    let _mode = EnvVarGuard::set("ARTERM_REASONING_DISPLAY", "full");
...
fn test_render_messages_hides_persisted_reasoning_in_current_mode() {
    ...
    let _env_lock = lock_env();
    let _mode = EnvVarGuard::set("ARTERM_REASONING_DISPLAY", "current");
    crate::config::invalidate_config_cache();
...
fn test_render_messages_hides_persisted_reasoning_in_off_mode() {
    ...
    let _env_lock = lock_env();
    let _mode = EnvVarGuard::set("ARTERM_REASONING_DISPLAY", "off");
    crate::config::invalidate_config_cache();
...
fn reasoning_trace_survives_session_save_and_load() -> Result<()> {
    let _env_lock = lock_env();
    let temp_home = tempfile::Builder::new()
        .prefix("arterm-reasoning-persist-test-")
        .tempdir()
        .map_err(|e| anyhow!(e))?;
    let _home = EnvVarGuard::set("ARTERM_HOME", temp_home.path().as_os_str());
...
fn streaming_guard_creates_visible_macos_sleep_assertion() {
    ...
    let reason = "Arterm streaming model response";
    {
