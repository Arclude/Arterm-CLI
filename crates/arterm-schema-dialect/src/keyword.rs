...
//!
//! Every provider-specific schema rewrite in arterm has to answer the same two
...
/// of the allow-list: a construct arterm has never seen cannot brick a provider.
