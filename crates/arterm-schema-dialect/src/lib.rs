...
//! # The recurring bug
//!
//! arterm sends its entire tool array on every request. Providers each accept a
...
//!    without waiting for a arterm release.
//!
//! # Adding a provider
//!
...
pub enum RecoveryAction {
    ...
    /// something arterm already strips or because it names nothing actionable.
