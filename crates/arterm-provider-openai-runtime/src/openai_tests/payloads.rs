...
fn test_websocket_continuation_request_excludes_transport_fields() {
    ...
    assert_eq!(continuation["prompt_cache_key"], "arterm-test-cache");
...
/// GPT-5.6 Sol is arterm's default OpenAI model and defaults to `low`
...
fn gpt_5_6_sol_defaults_to_low_reasoning_effort() {
    ...
    arterm_base::auth::codex::set_active_account_override(Some("sol-low-default-test".to_string()));
...
/// `.arterm/prompt-overlay.md`) were silently dropped in ChatGPT/Codex OAuth
