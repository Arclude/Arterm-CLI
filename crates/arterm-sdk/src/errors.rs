...
pub enum ErrorKind {
    ...
    Harness(arterm_harness_api::ErrorCode),
    /// I/O or JSON trouble on the transport.
    Transport,
    /// Starting a runtime (daemon or bridge) failed.
    LaunchFailed,
    /// The configured arterm executable could not be started.
    ArtermNotFound,
...
impl ErrorKind {
    ...
    pub fn code(&self) -> &'static str {
        match self {
            ...
            Self::ArtermNotFound => "arterm_not_found",
            ...
            Self::Harness(code) => match code {
                arterm_harness_api::ErrorCode::UnsupportedVersion => "unsupported_version",
                arterm_harness_api::ErrorCode::UnknownRequest => "unknown_request",
                arterm_harness_api::ErrorCode::UnknownSession => "unknown_session",
                arterm_harness_api::ErrorCode::InvalidRequest => "invalid_request",
                arterm_harness_api::ErrorCode::Internal => "internal",
            },
        }
    }
}
...
impl From<arterm_harness_api::FrameError> for Error {
    fn from(error: arterm_harness_api::FrameError) -> Self {
        let kind = match error {
            arterm_harness_api::FrameError::Eof => ErrorKind::Disconnected,
