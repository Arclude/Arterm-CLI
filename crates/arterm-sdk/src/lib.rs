//! Rust SDK for the arterm harness.
//!
//! The API crate (`arterm-harness-api`) defines the wire protocol. This crate
...
//!
//! ```no_run
//! use arterm_sdk::{ConnectOptions, ArtermClient, RunOptions};
//!
//! let client = ArtermClient::connect(ConnectOptions::default())?;
...
pub use launch::{
    ...
    socket_accepts, user_app_config_dir, user_arterm_home, wait_for_socket,
};
pub use structured::{
...
pub use arterm_harness_api as api;
pub use arterm_harness_api::{
