...
fn test_prepare_body_anchors_tool_image_after_tool_message() {
    ...
    assert_eq!(region.render, arterm_tui_messages::ImageRegionRender::Fit);
...
fn test_prepare_body_incremental_anchors_image_on_new_tool_message() {
    ...
    assert_eq!(
        ...
        arterm_tui_messages::ImageRegionRender::Fit
    );
...
fn test_prepare_body_with_math_never_blocks_on_a_stalled_tex_toolchain() {
    ...
    unsafe {
        std::env::set_var("ARTERM_LATEX_COMMAND", &stub);
        std::env::set_var("ARTERM_DVIPNG_COMMAND", &stub);
        std::env::set_var("ARTERM_PDFLATEX_COMMAND", &stub);
        std::env::set_var("ARTERM_PDFTOCAIRO_COMMAND", &stub);
    }
