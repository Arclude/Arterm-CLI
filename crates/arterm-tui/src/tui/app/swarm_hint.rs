...
pub(super) fn hint_message() -> String {
    "\u{2699} Swarm routing (models, effort) is configured by a prompt, not a config file. Edit ~/.arterm/swarm-prompt.md (or ./.arterm/swarm-prompt.md) to tune it".to_string()
}
