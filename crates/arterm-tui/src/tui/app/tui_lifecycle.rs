...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            hold_queued_followups_until_idle: false,
            ...
            pending_plan_mode_state: None,
            remote_bg_tasks: Vec::new(),
            last_remote_bg_list_at: None,
    ...
    fn restore_remote_startup_history(&mut self, session_id: &str) {
        ...
        // message buffers) drop before we strip and retain the session.
        {
            ...
            let display_messages =
                arterm_tui_messages::display_messages_from_rendered_messages(rendered_messages);
    ...
    pub fn new_for_remote_with_options(resume_session: Option<String>, fresh_spawn: bool) -> Self {
        ...
        let reload_fast_start = std::env::var("ARTERM_RELOAD_FAST_START")
        ...
        crate::env::remove_var("ARTERM_RELOAD_FAST_START");
