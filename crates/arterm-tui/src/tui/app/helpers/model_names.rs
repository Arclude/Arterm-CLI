...
pub(crate) fn pretty_model_display_name(model: &str) -> String {
    ...
    // a parenthetical, since they are arterm-side route markers rather than part
...
/// Bedrock vendor namespaces arterm knows how to render.
///
...
mod tests {
    ...
    fn dump_pretty_model_names_for_manual_audit() {
        ...
        for list in [
            ...
            arterm_provider_core::ALL_OPENAI_MODELS,
            arterm_provider_core::OPENAI_API_ONLY_PRO_MODELS,
        ] {
