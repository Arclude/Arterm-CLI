...
#[test]
fn test_subscription_command_shows_arterm_status_scaffold() {
    let _guard = crate::storage::lock_test_env();
    crate::subscription_catalog::clear_runtime_env();
    crate::env::remove_var(crate::subscription_catalog::ARTERM_API_KEY_ENV);
    crate::env::remove_var(crate::subscription_catalog::ARTERM_API_BASE_ENV);
    ...
    assert_eq!(msg.role, "system");
    assert!(msg.content.contains("Arterm Hosted Model Status"));
    ...
    assert!(msg.content.contains("/login arterm"));
...
fn test_subscribe_command_shows_hosted_pitch_and_next_step() {
    ...
    assert_eq!(msg.role, "system");
    assert!(msg.content.contains("Arterm hosted models"));
