...
/// RAII guard for the ARTERM_PIN_TODOS env override used by the band tests.
...
impl PinTodosEnvGuard {
    ...
    fn set(value: &str) -> Self {
        ...
        // ARTERM_PIN_TODOS state leaks into this one for up to 500ms.
...
impl Drop for PinTodosEnvGuard {
    fn drop(&mut self) {
        crate::env::remove_var("ARTERM_PIN_TODOS");
