//! Tests for the inline interactive pickers.
//!
//! Split out of `inline_interactive.rs` so that file can stay under the
//! code-size ratchet; the repo already uses this `#[path]` pattern.
