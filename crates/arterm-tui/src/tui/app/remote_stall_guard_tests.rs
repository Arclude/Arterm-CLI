//! Stall-guard tests for the remote loop.
//!
//! Split out of `remote.rs` so that file can stay under the code-size ratchet;
//! `remote.rs` already uses this `#[path]` pattern for its main test module.
