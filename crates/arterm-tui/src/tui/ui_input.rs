...
pub(super) fn draw_jump_to_bottom_overlay(frame: &mut Frame, app: &dyn TuiState, input_area: Rect) {
    let rect = if app.auto_scroll_paused() {
        super::jump_to_bottom_overlay_rect(input_area, frame.area())
    } else {
        None
    };
    super::record_jump_to_bottom_area(rect);
        ...
        match app.status() {
            ...
            ProcessingStatus::RunningTool(ref name) => {
                ...
                let bar_speed = if decorative {
                    ...
                    arterm_tui_style::theme::LIVENESS_INDICATOR_FPS / half_width as f32
                };
                ...
                spans.push(Span::styled(
                    format!(" · {} bg", arterm_tui_core::keybind::alt_chord("B")),
        ...
        append_batch_progress_spans(
            ...
            Some(crate::bus::BatchProgress {
                ...
                running: vec![crate::message::ToolCall {
                    ...
                    name: "bash".to_string(),
                    input: serde_json::json!({"command": "cargo test -p arterm"}),
                    intent: None,
