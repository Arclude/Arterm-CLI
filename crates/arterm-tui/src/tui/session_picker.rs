...
pub use arterm_tui_session_picker::{
...
impl SessionPicker {
    ...
    fn ensure_selected_preview_loading(&mut self) {
        ...
        let _ = std::thread::Builder::new()
            .name("arterm-session-preview-loader".to_string())
            .spawn(move || {
        ...
        let body = vec![
            Line::from(Span::styled(
                format!(
                    ...
                    arterm_core::util::truncate_str(session_id, 12)
                ),
                Style::default()
                    .fg(Color::White)
                    .add_modifier(Modifier::BOLD),
            ...
            Line::from(""),
            Line::from(Span::styled(
                "Arterm will prepare the transcript first, then ask Claude to exit.",
