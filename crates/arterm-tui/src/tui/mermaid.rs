pub use arterm_tui_mermaid::{
    ...
    deferred_render_pending_count, diagram_placeholder_lines, error_lines_for, error_to_lines,
    estimate_image_height, evict_old_cache, evict_render_cache_for_content, get_active_diagrams,
    get_cached_path, get_cached_png, get_font_size, image_protocol_available,
...
pub use arterm_tui_mermaid::{ImageScrollBenchmark, cache_stat_syscalls};

#[cfg(feature = "mmdr-size-api")]
pub use arterm_tui_mermaid::terminal_theme;

pub fn install_arterm_mermaid_hooks() {
    arterm_tui_mermaid::set_log_hooks(crate::logging::info, crate::logging::warn);
    arterm_tui_mermaid::set_render_completed_hook(|| {
        crate::bus::Bus::global().publish(crate::bus::BusEvent::MermaidRenderCompleted);
    });
    arterm_tui_mermaid::set_memory_snapshot_hook(|| {
        let snapshot = crate::process_memory::snapshot_with_source("client:mermaid:memory");
        arterm_tui_mermaid::ProcessMemorySnapshot {
