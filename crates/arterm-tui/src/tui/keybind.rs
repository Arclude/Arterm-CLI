...
pub use arterm_tui_core::keybind::{
...
pub use arterm_config_types::keybindings::{
...
pub(crate) fn side_panel_toggle_key_label() -> String {
    arterm_tui_core::keybind::alt_chord("M")
}
...
/// Optional binding that spawns a fresh arterm session in a new terminal window.
