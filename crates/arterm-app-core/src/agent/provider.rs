...
impl Agent {
    ...
    pub fn model_catalog_snapshot(&self) -> arterm_provider_core::ModelCatalogSnapshot {
    ...
    pub fn active_resolved_credential(&self) -> Option<arterm_provider_core::ResolvedCredential> {
